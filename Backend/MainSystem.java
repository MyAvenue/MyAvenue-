...
public class MainSystem {
    ...
    *   SIGNUP
     */
    public void signUp(String zID, String name, String password, String email, String phoneNumber) {
       
            Student newStudent = new Student(zID, name, password, email, phoneNumber);
